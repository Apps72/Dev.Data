...
namespace Apps72.Dev.Data
{
    ...
    public partial class DatabaseCommand : IDatabaseCommand, IDatabaseCommandBase
    {
        #region EVENTS
        ...
        public DatabaseCommand(DbConnection connection, DbTransaction transaction, int commandTimeout)
            : this(connection?.CreateCommand(), transaction, commandTimeout)
        {
        ...
        protected DatabaseCommand(DbCommand command, DbTransaction transaction, int commandTimeout)
        {
