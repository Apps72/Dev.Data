    ...
    public class FormattedTextTests
    {
        ...
        public void GetFormattedAsText_Simple_Test()
        {
            using (var cmd = new DatabaseCommand(_connection))
            {
                ...
                Assert.AreEqual(" SELECT * FROM EMP ", cmd.GetCommandTextFormatted());
            }
        }

        [TestMethod]
        public void FormattedCommandText_Test()
        {
            using (var cmd = new DatabaseCommand(_connection))
            {
                cmd.CommandText = " SELECT * FROM EMP ";
                Assert.AreEqual(" SELECT * FROM EMP ", cmd.FormattedCommandText);
            }
        }
